...
9. Table S9. Raw counts of TCGA WGS samples classified at the genus level against Microbial2023 database, for samples and genera used in both this study and in the Poore et al. study. This resulted in 4,550 samples and 1,285 genera.
10. Table S10. Raw counts from the Poore et al. study at the genus level, for samples and genera used in both this study and Poore et al. This resulted in 4,550 samples and 1,285 genera. Raw counts included here were taken directly from Poore et al. (2020).
