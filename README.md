...
13. Table S13. TCGA metadata for 5,734 samples, including unique IDs for this study, IDs used by Poore et al., IDs used by Narunsky-Haziza et al., and the original TCGA identifiers, followed by read length (rd_len), total number of read alignments (tot_aln), GRCh38 unaligned read counts (grch38_unmaped), GRCh38 and CHM13 unaligned read counts (grch38+chm13_unmapped).
